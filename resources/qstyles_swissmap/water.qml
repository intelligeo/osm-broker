...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="1" maximumScale="3e+06" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{ae9079bf-064d-496f-a5fe-45dc71f3b3ad}">
      <rule filter="type = 'reservoir_covered'" key="{e39c799a-e0d7-45ce-863a-0b1db6e3f5e8}" symbol="0" label="reservoir"/>
      <rule scalemaxdenom="150000" filter="type = 'riverbank'" key="{e9b62a27-e00c-41a8-af08-998c85cc3225}" symbol="1" scalemindenom="1" label="river"/>
      <rule filter="type = 'water'" key="{9b382ed5-677f-4b57-80aa-5143a0b0d7d6}" symbol="2" label="water"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="212,231,247,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="14,125,194,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.12"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
