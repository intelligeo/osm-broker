...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="100100" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{d7758272-4e10-4e60-abeb-8ca29f6a9301}">
      <rule scalemaxdenom="15000" filter="type IN ('rail', 'railway')" key="{8e58d365-f856-4066-9ed8-9f266b9d29d8}" symbol="0" scalemindenom="1" label="railway track"/>
      <rule scalemaxdenom="150000" filter="type IN ('rail', 'railway')" key="{dea1caed-78fa-49c7-8bba-79df1ca20f68}" symbol="1" scalemindenom="15000" label="railway track 100"/>
      <rule scalemaxdenom="350000" filter="type IN ('rail', 'railway')" key="{2cd8e939-ebae-4123-bfbf-547b198eaaa2}" symbol="2" scalemindenom="150000" label="railway track 200"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="89,13,0,255"/>
  ...
  <aliases>
    ...
    <alias field="z_order" index="14" name=""/>
    <alias field="bridge" index="15" name=""/>
    <alias field="tunnel" index="16" name=""/>
    <alias field="voltage" index="17" name=""/>
    <alias field="frequency" index="18" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="frequency"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="voltage" expression=""/>
    <default field="frequency" expression=""/>
  </defaults>
