...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+06" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{85fbab46-aa7f-4ef4-b331-b994dbd266a9}">
      <rule scalemaxdenom="75000" filter="type IN ('river', 'canal')" key="{0b6cfdca-e7bb-4137-83ac-e2ed8eb0ed7f}" symbol="0" scalemindenom="1" label="main river"/>
      <rule scalemaxdenom="75000" filter="type NOT IN ('river', 'canal')" key="{8f4574a5-feba-4cd8-ad4c-384d37a732ad}" symbol="1" scalemindenom="1" label="small river"/>
      <rule scalemaxdenom="150000" filter="type IN ('river', 'stream', 'canal')" key="{b9964a56-495d-414d-bd17-c444fd162784}" symbol="2" scalemindenom="75000" label="main river 100"/>
      <rule scalemaxdenom="350000" filter="type IN ('river', 'stream', 'canal')" key="{8fc479bf-90a8-45d0-a84b-199dd52a3524}" symbol="3" scalemindenom="100000" label="main river 200"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{3c48778b-570c-429c-b791-f2500d2628e2}">
      <rule scalemaxdenom="150000" description="main river" filter="fclass IN ('river', 'stream', 'canal')" key="{5cc7badc-135c-495f-bd23-340bedf661bc}" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,77,168,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="8.25" fieldName="name" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <placement repeatDistanceUnit="1" placement="3" maxCurvedCharAngleIn="20" repeatDistance="500" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="0" distMapUnitScale="0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" repeatDistanceMapUnitScale="0,0,0,0,0,0" centroidWhole="0" priority="8" yOffset="0" offsetType="0" placementFlags="2" centroidInside="0" dist="0.1" angleOffset="0" maxCurvedCharAngleOut="-20" fitInPolygonOnly="0" quadOffset="4" labelOffsetMapUnitScale="0,0,0,0,0,0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;area&quot;" sortOrder="0">
    <columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets>
    <widget name="water_OpRm_LV95_area">
      <config/>
    </widget>
    <widget name="water_OpRm_LV95_code">
      <config/>
    </widget>
    <widget name="water_OpRm_LV95_fclass">
      <config/>
    </widget>
    <widget name="water_OpRm_LV95_name">
      <config/>
    </widget>
    <widget name="water_OpRm_LV95_osm_id">
      <config/>
    </widget>
  </widgets>
  <conditionalstyles>
